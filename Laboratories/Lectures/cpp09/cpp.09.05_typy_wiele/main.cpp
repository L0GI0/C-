...
/// \version 0.1
/// \date 22-11-2004
/// \brief Functions templates. Many types.
/////////////////////////////////////////////////////////////////////////
...
int main(int argc, char** argv)
{
	...
	OOP::CFraction aFrac(2, 5), bFrac(13, 50);
	...
	cout << "max<double, double>(b, d) = " << OOP::max<double, double>(b, d) << endl;
	cout << "min<double, double>(c, a) = " << OOP::min<double, double>(c, a) << endl;
